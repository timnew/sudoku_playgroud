class SudokuPos {
  ...
  factory SudokuPos.index(int index) => SudokuPos._(index ~/ 9, index % 9, index);

  Iterable<SudokuPos> parentRow() => Iterable.generate(9, (i) => SudokuPos(row, i));

  Iterable<SudokuPos> parentColumn() => Iterable.generate(9, (i) => SudokuPos(i, col));

  Iterable<SudokuPos> parentBlock() => Iterable.generate(9, (i) => blockPos + i);

  @override
  String toString() => "[$row,$col]";

  @override
  bool operator ==(Object other) => other is SudokuPos ? index == other.index : false;
...
class SudokuSubPos {
  ...
  SudokuPos operator +(int index) => SudokuPos(row * 3 + index ~/ 3, col * 3 + index % 3);

  SudokuPos operator *(SudokuSubPos pos) => SudokuPos(row * 3 + pos.row, col * 3 + pos.col);
  ...
  SudokuSubPos nextPosHorizontally() => lastOfSubArea ? null : SudokuSubPos.index(index + 1);
  ...
  @override
  bool operator ==(Object other) => other is SudokuSubPos ? index == other.index : false;
